 ...
 * Not osWaitForever, so that the link status may be checked often enough
 * from the same thread. */
#define TIME_WAITING_FOR_INPUT                 ( 2000 )
...
ETH_DMADescTypeDef  DMARxDscrTab[ETH_RXBUFNB] __attribute__((section(".sram2_non_cached_device"),zero_init));/* Ethernet Rx MA Descriptor */
